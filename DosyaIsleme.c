...
int main(){
    ...
    if (islem <=0 || islem > 3) 
    {
        ...
        printf("Tekrar denemek icin lutfen 1'e basiniz(Hayir ise 0'a)  ::: "); scanf("%d",&istek);
        if (istek == 1)
        {
            goto tekrar;
        }
    ...
    {
    case 1:
        printf(" Lutfen Olusturmak istediginiz dosya adini .txt ekleyerek giriniz  ::: ");        scanf("%s",&isim);
        fp = fopen (isim, "w"); 
        fclose(fp);
        break;
    case 2:
        printf("Lutfen Silmek istediginiz dosya adini .txt ekleyerek giriniz  ::: ");        scanf("%s",&isim);
    ...
    printf("\n\n\n Baska bir islem yapmak istermisiniz evet ise 1'e hayir ise 0'a basiniz  ::: ");    scanf("%d",&istek);
    if (istek == 1)
    {
        goto tekrar; 
    }else{
